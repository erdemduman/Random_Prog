...
def chooseAlbum():
    ...
    spotify = login()
    album_list = []
    albums = spotify.artist_albums(chooseBand(), album_type='album')
...
def chooseTrack():
    spotify = login()
    track_list = []
    track = spotify.album_tracks(chooseAlbum(), limit=50, offset=0)
